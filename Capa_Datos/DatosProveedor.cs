    ...
    public class DatosProveedor
    {
        ...
        public string agregar(DatosProveedor proveedor)
        {
            ...
            try
            {
                ...
                SqlParameter parTel = ProcAlmacenado.asignarParametros("@telefono", SqlDbType.BigInt, proveedor.Tel);
                comando.Parameters.Add(parTel);

                SqlParameter parNumDocumento = ProcAlmacenado.asignarParametros("@num_documento", SqlDbType.BigInt, proveedor.NumDocumento);
        ...
        public DataTable buscarTexto(DatosProveedor proveedor, int modo = 4)
        {
            //Modo 4 para DB
            SqlConnection cn = new SqlConnection(Conexion.conexion);
