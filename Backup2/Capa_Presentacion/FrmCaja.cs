...
namespace Capa_Presentacion
{
    public partial class FrmCaja : Form
    {
        ...
        private void FrmCaja_Load(object sender, EventArgs e)
        {
            ...
            {
                if (objcaja.Fecha.Substring(0, 10) != dtpFechaCaja.Value.ToString("dd/MM/yyyy") && NegocioConfigEmpresa.confsistema("controlarcierrediariocaja").ToString() == "True")
                {
                    if (objcaja.Codcuenta == 9100001)
                    {
                        ...
                        if (dialogResult == DialogResult.Yes)
                        {
                            ...
                            if (objcaja.Estadocierre == "ABIERTO")
                            {
                                UtilityFrm.mensajeError("El turno todavia se encuentra abierto, no se puede cerrar caja");
                                return;
                            }
        ...
        private void actualizabotonesturno()
        {
            Negociocaja objcaja = new Negociocaja();
            objcaja.extestadoturno(1, "", NegocioConfigEmpresa.nrocaja, idcierre, idturno);
        ...
        public void refrescarcaja(string fecha)
        {
            ...
            actualizarultimoidcierreidturno();
            DataTable midatatable = Negociocaja.buscarmovimiento(fecha.Substring(0, 10) + " 00:00:00", fecha.Substring(0, 10) + " 23:59:59", NegocioConfigEmpresa.nrocaja,7,idcierre,idturno);
        ...
        private void totales()
        {
          ...
          float   varegreso = 0;
            ...
            {
                if (row.Cells["Cod_cuenta"].Value.ToString () != "9100005")
                {
        ...
        { 
         ...
         // BtnCierreTurno.Enabled = habloq2;
        ...
        private void BtnApertura_Click(object sender, EventArgs e)
        {
            ...
            {
                objformapcaja.lblCaja.Text = "CAJA";
        ...
        private void BtnCierreTurno_Click(object sender, EventArgs e)
        {
            Negociocaja objcaja = new Negociocaja();
            FrmCerrarCaja objcerrar = new FrmCerrarCaja();
            objcerrar.label16.Text = "CIERRE DE TURNO";
            objcerrar.BtnApertura.ButtonText = "CERRAR TURNO";
            objcerrar.ShowDialog();
            objcaja.extrestadocaja(1, "", 0, false, NegocioConfigEmpresa.nrocaja);
            estadoabicerrada(objcaja.Codcuenta);
            actualizabotonesturno();
        ...
        private void BtnAbrirTurno_Click(object sender, EventArgs e)
        {
            ...
            if (objcaja.chequeocaja("frmPventa2", ref mensaje, NegocioConfigEmpresa.nrocaja) == false)
            {
                UtilityFrm.mensajeError("No se puede darle apertura al turno, " + mensaje);
                return;
            }
            

            objformapcaja.lblCaja.Text = "TURNO";
            objformapcaja.ShowDialog();
            refrescarcaja(Convert.ToString(DateTime.Today));
            actualizabotonesturno();
            totales();
        ...
        private void BtnHistorialCaja_Click(object sender, EventArgs e)
        {
            FrmCajaHistorial objcaja = new FrmCajaHistorial();
            objcaja.Show();
        }
    }
}
