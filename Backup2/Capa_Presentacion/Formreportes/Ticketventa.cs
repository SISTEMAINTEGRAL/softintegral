...
namespace Capa_Presentacion.Formreportes
{
    public partial class Ticketventa : Form
    {
        ...
        public void imprimir()
        {
            ...
            string formatoimpresionelectronica = "A4";
            string impresora = "";

            midatareader = NegocioConfigEmpresa.mostrarformatoimpresora(1);

            if (midatareader.Read() == true)
            {
                impresora = Convert.ToString(midatareader["impresora"]);
                formatoimpresionelectronica = Convert.ToString(midatareader["formato"]);
            }
                ...
                try
            {
                ...
                switch (formatoimpresionelectronica)
                {
                   case "TICKET80" :
                   {
